...
public class FragmentDetalle extends Fragment {
   ...
   public static final String CLAVE_CONTACTO_DETALLE = "contacto";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Contacto contacto = (Contacto) elBundleQueMeMandoLaActivity.getSerializable(CLAVE_CONTACTO_DETALLE);
        ...
        descripcionDetalle.setText(contacto.getDescripcion());
        imagenDetalle.setImageResource(contacto.getIntImagen());
